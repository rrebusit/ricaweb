...
```{r}
pakistan <- read.csv("~/Downloads/website-basic-rrebusit/Rainfall_1901_2016_PAK.csv")
```

The data is from kaggle and the link to it is right here -\> [Click Me](%22https://www.kaggle.com/datasets/zusmani/rainfall-in-pakistan%22)
