...
<center>![Image of deforestation from Los Angeles Times](~/Downloads/website-basic-rrebusit/deforestation.jpeg)</center>
...
<center>![Image of Pakistan from Nations Online Project](~/Downloads/website-basic-rrebusit/pakistan.jpeg)</center>
...
<center>![People affected from monsoon Image from CNN](~/Downloads/website-basic-rrebusit/monsoon.jpeg)</center>
...
<center>![Tending to the sick, Image from AP News](~/Downloads/website-basic-rrebusit/ill.jpeg)</center>
...
<center>![Livestock struggling in floods, Image from ProPakistani](~/Downloads/website-basic-rrebusit/livestock.jpeg)</center>
...
Let's perform some brief exploratory data analysis and if you want to check out the full process, click this link: [Pakistan Rainfall Code](https://data485-s22.github.io/website-basic-rrebusit/PakistanRainfallCode.html)

We can take a look at the histogram of the rainfall

<center>![Histogram](~/Downloads/website-basic-rrebusit/histogram.png){width="600"}</center>

We can also take a look at the average amount of rainfall during these years and months

<center>![Average](~/Downloads/website-basic-rrebusit/average.png)</center>
...
```{r, echo = FALSE}
load("~/Downloads/website-basic-rrebusit/lm2.Rdata")
```
...
<center>![Rainfall from January 2017, recorded by National Centers for Environmental Information](~/Downloads/website-basic-rrebusit/2017prediction.png){width="600"}</center>
...
<center>![UNICEF, Image from Diplomatic News Agency](~/Downloads/website-basic-rrebusit/help.jpeg)</center>
...
![ ](~/Downloads/website-basic-rrebusit/thanks.png)
